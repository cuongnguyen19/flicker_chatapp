...
import ConversationContextMenu from "@/app/archivedChat/[id]/conversationContextMenu";
    ...
    return (
      ...
      >
        ...
        >
            <div>
              <div
                  className={`min-w-[80px] relative after:content-[''] after:border-white after:border-2 after:absolute after:bottom-1 after:left-16 after:w-4 after:h-4 after:rounded-full after:bg-green-500`}
              >
                <Image
                    src={
                      data.avatar
      ...
      return (
        ...
        >
          ...
          >
            <div>
              <div
                className={`min-w-[80px] relative after:content-[''] after:border-white after:border-2 after:absolute after:bottom-1 after:left-16 after:w-4 after:h-4 after:rounded-full ${
