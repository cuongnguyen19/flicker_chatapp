...
const confirmUnhideConversationModal = ({ user, conversation, open, onCancel, messageApi, dispatch }: Props) => {
...
export default connect(mapState)(confirmUnhideConversationModal);
