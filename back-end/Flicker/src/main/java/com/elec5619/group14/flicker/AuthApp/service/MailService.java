...
import com.elec5619.group14.flicker.AuthApp.model.Mail;
...
public class MailService {
    ...
    public void sendEmailVerification(String emailVerificationUrl, String to, String userName)
        ...
        Mail mail = new Mail();
        mail.setSubject("Email Verification [Team Flicker]");
        mail.setTo(to);
     ...
     */
    public void sendResetLink(String resetPasswordLink, String to, String userName)
            throws IOException, TemplateException, MessagingException {
        ...
        Mail mail = new Mail();
        mail.setSubject("Password Reset Link [Team Flicker]");
        mail.setTo(to);
        mail.setFrom(mailFrom);
        mail.getModel().put("userName", userName);
     ...
     * status
     */
    public void sendAccountChangeEmail(String action, String actionStatus, String to, String userName)
            throws IOException, TemplateException, MessagingException {
        Mail mail = new Mail();
        mail.setSubject("Account Status Change [Team Flicker]");
        mail.setTo(to);
        mail.setFrom(mailFrom);
        mail.getModel().put("userName", userName);
