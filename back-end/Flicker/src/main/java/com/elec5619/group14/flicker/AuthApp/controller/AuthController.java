...
import com.elec5619.group14.flicker.AuthApp.event.OnGenerateResetLinkEvent;
import com.elec5619.group14.flicker.AuthApp.event.OnRegenerateEmailVerificationEvent;
import com.elec5619.group14.flicker.AuthApp.event.OnUserAccountChangeEvent;
import com.elec5619.group14.flicker.AuthApp.event.OnUserRegistrationCompleteEvent;
import com.elec5619.group14.flicker.AuthApp.exception.InvalidTokenRequestException;
import com.elec5619.group14.flicker.AuthApp.exception.PasswordResetException;
import com.elec5619.group14.flicker.AuthApp.exception.PasswordResetLinkException;
import com.elec5619.group14.flicker.AuthApp.exception.TokenRefreshException;
import com.elec5619.group14.flicker.AuthApp.exception.UserLoginException;
import com.elec5619.group14.flicker.AuthApp.exception.UserRegistrationException;
import com.elec5619.group14.flicker.AuthApp.model.CustomUserDetails;
import com.elec5619.group14.flicker.AuthApp.model.payload.ApiResponse;
import com.elec5619.group14.flicker.AuthApp.model.payload.JwtAuthenticationResponse;
import com.elec5619.group14.flicker.AuthApp.model.payload.LoginRequest;
import com.elec5619.group14.flicker.AuthApp.model.payload.PasswordResetLinkRequest;
import com.elec5619.group14.flicker.AuthApp.model.payload.PasswordResetRequest;
import com.elec5619.group14.flicker.AuthApp.model.payload.RegistrationRequest;
import com.elec5619.group14.flicker.AuthApp.model.payload.TokenRefreshRequest;
import com.elec5619.group14.flicker.AuthApp.model.token.EmailVerificationToken;
import com.elec5619.group14.flicker.AuthApp.model.token.RefreshToken;
import com.elec5619.group14.flicker.AuthApp.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity resetLink(@Param(value = "The PasswordResetLinkRequest payload") @Valid @RequestBody PasswordResetLinkRequest passwordResetLinkRequest) {
        ...
        return authService.generatePasswordResetToken(passwordResetLinkRequest)
                .map(passwordResetToken -> {
                    ...
                    UriComponentsBuilder urlBuilder = ServletUriComponentsBuilder.fromHttpUrl("http://localhost:3000/resetpassword?email=" + passwordResetLinkRequest.getEmail());
    ...
    @Operation(summary = "Confirms the email verification token that has been generated for the user during " +
            "registration")
    public ModelAndView confirmRegistration(@Param(value = "the token that was sent to the user email") @RequestParam("token") String token) {
        ...
        return new ModelAndView( "redirect:http://localhost:3000/login?status=successful");
    }
