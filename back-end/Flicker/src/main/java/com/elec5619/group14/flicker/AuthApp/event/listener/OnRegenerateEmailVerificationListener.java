 ...
 */
package com.elec5619.group14.flicker.AuthApp.event.listener;
...
import com.elec5619.group14.flicker.AuthApp.service.MailService;
...
public class OnRegenerateEmailVerificationListener implements ApplicationListener<OnRegenerateEmailVerificationEvent> {
    ...
    private void resendEmailVerification(OnRegenerateEmailVerificationEvent event) {
        ...
        try {
            mailService.sendEmailVerification(emailConfirmationUrl, recipientAddress, userName);
