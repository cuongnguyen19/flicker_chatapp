...
import com.capstone.project.flicker.AuthApp.model.DeviceType;
...
public class DeviceInfo {
    ...
    @Schema(name = "Device type", required = true, type = "string", allowableValues =
            "DEVICE_TYPE_ANDROID, DEVICE_TYPE_IOS, DEVICE_TYPE_WINDOWS,\n" +
                    "    DEVICE_TYPE_MACOS,\n" +
                    "    DEVICE_TYPE_LINUX,\n" +
                    "    DEVICE_TYPE_UNIX,\n" +
                    "    DEVICE_TYPE_UNKNOWN")
