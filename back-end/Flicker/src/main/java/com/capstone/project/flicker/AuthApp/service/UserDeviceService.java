...
import com.capstone.project.flicker.AuthApp.repository.UserDeviceRepository;
import com.capstone.project.flicker.AuthApp.model.UserDevice;
import com.capstone.project.flicker.AuthApp.model.payload.DeviceInfo;
...
public class UserDeviceService {
    ...
    public UserDevice createUserDevice(DeviceInfo deviceInfo) {
        ...
        if(deviceInfo.getNotificationToken() != null && !deviceInfo.getNotificationToken().equals(""))
            userDevice.setNotificationToken(deviceInfo.getNotificationToken());
        else
            userDevice.setNotificationToken(deviceInfo.getDeviceId() + "-" + deviceInfo.getDeviceType());
